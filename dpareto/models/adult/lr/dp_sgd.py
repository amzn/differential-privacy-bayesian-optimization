...
class DpAdultLrSgd(AdultLrBase):
    def __init__(self, hyperparams, options={}):
        super(DpAdultLrSgd, self).__init__(hyperparams, options)

        self._input_layer = 123
        self._hidden_layers = []
        self._output_layer = 1

        self._name = 'dp_adult_lr_sgd'


# Small run for testing purposes.
def main():
    print("Running dp_adult_lr_sgd's main().")
    ...
    instance = DpAdultLrSgd(hyperparams, options)
