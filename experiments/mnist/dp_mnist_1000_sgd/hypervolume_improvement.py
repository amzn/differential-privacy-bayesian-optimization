...
def main():
    ...
    instance_options = {'use_gpu': True, 'verbose': True, 'compute_epoch_accuracy': False, 'hidden_layers': [1000]}
    ...
    num_replications = 10
    num_workers = 8
    harness = HypervolumeImprovementHarness(DpMnistSgd, 'dp_mnist_1000_sgd', initial_data_options, anti_ideal_point, optimization_domain, fixed_hyperparams, instance_options, num_instances, num_replications, num_workers, plot_options, output_dir)
    harness.run()
