...
def main():
    ...
    instance_options = {'use_gpu': True, 'verbose': False, 'accumulate_privacy': True, 'hidden_layers': [1000]}
    ...
    num_replications = 10
    num_workers = 4
    harness = RandomSamplingHarness(DpMnistSgd, 'dp_mnist_1000_sgd', hyperparam_distributions, instance_options, num_instances, num_replications, num_workers, output_dir)
    harness.run()
